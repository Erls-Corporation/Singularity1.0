...
AjaxControlToolkit.SliderBehavior.prototype = {
    ...
    _initializeLayout : function() {
        ...
        var defaultHandleImageUrl = (this._isHorizontal) ? '<%= WebResource("App.Model.Model.Ui.Web.Controls.Ajax.Slider.Images.slider_h_handle.gif") %>'
            : '<%= WebResource("App.Model.Model.Ui.Web.Controls.Ajax.Slider.Images.slider_v_handle.gif") %>';
